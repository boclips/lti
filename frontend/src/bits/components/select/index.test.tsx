...
describe('Select dropdown', () => {
  it('Renders select dropdown', () => {
    render(<SelectFilter touched={jest.fn()} options={filters} title="Ages" onApply={() => {
    }}/>);
  ...
  it('Returns selected options when clicking apply', async () => {
    ...
    render(<SelectFilter touched={jest.fn()} options={filters} title="Ages" onApply={onApply} />);
  ...
  it('can filter options when allowSearch is set -  case insensitive', () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('Search for subject'), { target: { value: 'Other' } });
